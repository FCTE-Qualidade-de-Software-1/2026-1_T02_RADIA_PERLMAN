...
| **Próximas equipes da disciplina MDS** | Desenvolvedor (sucessor) | Herdar o código com previsibilidade, isto é, saber o que mantém, refatora ou substitui. | Receber um *backlog* de qualidade ranqueado por risco. | Justificou a decisão D2 do propósito (§1) e a inclusão de **Confiabilidade** (§5). |
