...
A distribuição abaixo foi elaborada a partir do histórico de *commits* e do registro de
autoria/revisão de cada seção da Fase 1 (ver tabelas "Histórico de versão" no rodapé de
cada uma das sete seções do relatório).
