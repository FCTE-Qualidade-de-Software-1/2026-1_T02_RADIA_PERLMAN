...
| §5 Características | Padronização de tabela e diagrama; revisão de redação dos *trade-offs*. | Os pesos da matriz, as notas atribuídas e o ranking P1–P4 — definidos em reunião presencial; a IA **não** atribuiu notas. |
